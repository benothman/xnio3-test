 ...
 * {@code Xnio3Client}
 * 
 * Created on Nov 10, 2011 at 4:26:24 PM
 * 
 * @author <a href="mailto:nbenothm@redhat.com">Nabil Benothman</a>
 */
public class Xnio3Client extends Thread {
	...
	/**
	 * Create a new instance of {@code Xnio3Client}
	 * 
	 * @param hostname
	 * @param port
	 * @param d_max
	 * @param delay
	 */
	public Xnio3Client(String hostname, int port, int d_max, int delay) {
	 ...
	 * @param delay
	 */
	public Xnio3Client(String hostname, int port, int delay) {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length < 2) {
			System.err.println("Usage: java " + Xnio3Client.class.getName()
		...
		Xnio3Client clients[] = new Xnio3Client[n];

		for (int i = 0; i < clients.length; i++) {
			clients[i] = new Xnio3Client(hostname, port, delay);
		}
